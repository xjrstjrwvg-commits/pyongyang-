    ...
    def solve(path):
        ...
        if len(path) == max_len:
            ...
            if must_chars:
                ...
                if limit_one and sum(full_text.count(mc) for mc in must_chars) != 1: return
